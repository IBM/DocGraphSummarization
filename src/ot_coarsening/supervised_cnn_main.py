...
parser.add_argument('--embedding_mapping', type=bool, default=False) 
...
if __name__ == "__main__":
    ...
    args.supervised_epochs = 0
    args.unsupervised_epochs = 15
    args.triplet_loss = False
    main()
    main()
    main()
    ...
    args.mode = "supervised" 
    args.supervised_epochs = 15
    args.unsupervised_epochs = 10
    args.triplet_loss = True
    main()
    main()
    main()
    main()
